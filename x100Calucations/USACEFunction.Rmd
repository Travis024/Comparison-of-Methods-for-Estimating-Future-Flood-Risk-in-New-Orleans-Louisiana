...
generateUSACE <- function(seaLevelData, statParams, timeProj, iterations = 2064, yearStart = 2016, yearEnd = 2065, returnPeriod = 100, uniformStart = 1.5, uniformEnd = 2){
  ...
  for(i in 1:iterations){
    ...
    # TW: call this "SurgeFactor" or something to make it distinct from the storm surge itself (since this is an increase in storm surge)
    ...
    # TW: call this returnLevel (to be analogous to the named returnPeriod input)
  ...
  # TW: I'd leave this out, since you won't always want to immediately create a plot
  # typically, a nice workflow is to have all the calculations/analysis in one "unit", and then the plotting routines somewhere else
