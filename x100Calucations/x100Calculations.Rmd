...
#If it isn't the start year, calcualte the vector of values for year i
  ...
  vectorYeari <- apply(params5, 1, function(thisRow) qevd(qevdProb, thisRow["u"], sigmaNonstat(thisRow["s0"], thisRow["s1"], i), xiNonstat(thisRow["xi0"], thisRow["xi1"], i)))
...
myPathYearPlot <- file.path("C:","Users","Travis", "Desktop", "Summer Research", "Comparison-of-Methods-for-Estimating-Future-Flood-Risk-in-New-Orleans-Louisiana-master", "x100Calculations", "parameter2Years" ,paste("parameter2_", i, ".jpg", sep = ""))
...
plot(densityYearStart, type = "l", col = "red", main = "Params5 - Density Distribution of x100 values from 2016 to 2065", xlab = "Sea Level [mm]", ylab = "Density")
...
if(i > yearStart){
 myPathDifferencesPlot <- file.path("C:","Users","Travis", "Desktop", "Summer Research", "Comparison-of-Methods-for-Estimating-Future-Flood-Risk-in-New-Orleans-Louisiana-master", "x100Calculations", "parameter2Differences" ,paste("differences_", i, ".jpg", sep = ""))
