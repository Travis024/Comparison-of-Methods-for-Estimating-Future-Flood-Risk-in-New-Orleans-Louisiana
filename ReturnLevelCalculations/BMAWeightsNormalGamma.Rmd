...
params1 <- paramsNormalGamma[[1]] #All stationary
params2 <- paramsNormalGamma[[2]] #Mu nonstationary
params3 <- paramsNormalGamma[[3]] #Sigma nonstationary
params4 <- paramsNormalGamma[[4]] #Xi nonstatioanry
params5 <- paramsNormalGamma[[5]] #Mu/Sigma nonstationary
params6 <- paramsNormalGamma[[6]] #Mu/Xi nonstationary
params7 <- paramsNormalGamma[[7]] #Sigma/Xi nonstationary
params8 <- paramsNormalGamma[[8]] #All nonstationary
...
plot(density(weightedDistribution, from = 0, to = 20000), main = "Distribution of Weighted x100 Values Over Time", xlab = "Sea Level [mm]", ylab = "Density")
