...
plot(200:1300, devd(200:1300, gev_stat[randomIndex,1], gev_stat[randomIndex,2], gev_stat[randomIndex,3]), type = "l", col = "red", main = "Army Corps of Engineers Method for Projecting Increases in Storm Surge Hazard", xlab = "Sea Level [meters]", ylab = "f(x)", cex.main = 1)


#Then plot that same gev but shifted
#First find the amount to shift by
surgeIncrease <- surge_factor[randomIndex] * projectedChange85[randomIndex]

#Sorge the shifted GEV
shiftedGEV <- devd(200:1300, gev_stat[randomIndex,1], gev_stat[randomIndex,2], gev_stat[randomIndex,3]) + surgeIncrease

#Add the shifted GEV to the plot
lines(200:1300, shiftedGEV, col = "blue")
